  ...
  <main id="wt-main" class="wt-main wt-haslayout wt-innerbgcolor">
    ...
    <div class="wt-haslayout wt-main-section">
      <div class="wt-btnarea" style="text-align: center;">
        ...
        <h4 style="color: darkgreen;"><?php if ($_GET['msg'] == 1) {echo "accsepted suseesfuly"; } ?></h4>
      </div>
      <div class="container">
                              ...
                              <ul class="wt-postarticlemeta">
                                ...
                                <li>
                                  <a href="javascript:void(0);">
                                    ...
                                    <span><a style="color: black; href="showjobdetails.php?job_id=<?php echo $row['prix']; ?>">Prix :<?php echo $row['prix']; ?> </a></span> <br>
                                  </a>
                                </li>
                                <li>
                                  <a href='deletepandingjob.php?id=<?php echo urlencode($row["id"]); ?>'>Delete</a>
                                </li>
                                <li>
                                  <a href="acceptjob.php?id=<?php echo urlencode($row["id"]); ?>" style="color: darkgreen;">Acccept</a>
                                </li>
                              </ul>
                            </div>
                          </div>
