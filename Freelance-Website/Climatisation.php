...
$query = "SELECT * FROM jobs where categorie = 'Climatisation'";
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
                        <div class="wt-articletabshold">
                            <ul class="wt-navarticletab nav navbar-nav">
                                <li class="nav-item">
                                    <a class="active" id="all-tab" data-toggle="tab" href="Climatisation.php">Climatisation</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a id="marketing-tab" data-toggle="tab" href="Forgeron.php">Forgeron</a>
                                </li>
                            </ul>
